...
public final class Constants {
  public static final class DriveConstants {
   ...
   // THIS IS THE AREA WE DID NOT HAVE WE COULD NOT INSTANTIATE OUR ENCODER ID'S
    ...
    public static final int RearRightCANcoderId = 12;
    public static final int RearLeftCANcoderId = 13;
  ...
  public static final class ModuleConstants {
    ...
    public static final double kTurningEncoderPositionPIDMinInput = 0.5; // radians
    ...
    public static final double kTurningMinOutput = -.5;
    public static final double kTurningMaxOutput = 0.5;
